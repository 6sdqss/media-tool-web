...
# --- CHẠY CHẾ ĐỘ 3 ---
def run_mode_web(w, h, drive_service, upload_link, extract_drive_id_and_type):
    st.info("💡 **HƯỚNG DẪN:** Dán link sản phẩm (hỗ trợ cả link rút gọn). Hệ thống tự phân tích cấu trúc màu.")
            ...
            if not selected_tasks:
                ...
                with tempfile.TemporaryDirectory() as temp_dir:
                    ...
                    if st.session_state.download_status == 'cancelled':
                        ...
                        shutil.make_archive(temp_path / "Web_Images_Done", 'zip', final_dir)
